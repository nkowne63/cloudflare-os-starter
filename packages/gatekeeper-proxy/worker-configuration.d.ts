/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 9bda964cdfba6c65f22d63c5fc3afcfd)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 allow_irrevocable_stub_storage,global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	PROXY_SERVICES: "{\"esm\":{\"upstream\":\"https://esm.sh\",\"via\":\"public\",\"writeMethods\":\"deny\"}}";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index.js");
		durableNamespaces: "ProxyGatekeeper";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROXY_SERVICES">> {}
}
